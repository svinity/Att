...
import { Settings, User, CreditCard, ShieldAlert, Trash, Edit2, HardHat, LogOut, CheckCircle, ChevronRight, X, Info } from 'lucide-react';
...
export default function SettingsScreen({
  ...
  const [activeTab, setActiveTab] = useState<'Workers' | 'Transactions'>('Workers');
